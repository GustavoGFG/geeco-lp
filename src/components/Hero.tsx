...
export const Hero = () => {
  return (
    <section className="relative w-full flex items-center justify-center lg:h-[calc(100dvh+400px)] min-h-max h-[calc(100dvh+0px)] md:bg-[url('/images/hero-bg-geeco2.png')] bg-[url('/images/hero-bg-geeco.png')] bg-cover bg-center bg-no-repeat py-12 px-4 shadow-md shadow-tradeoff-primary">
